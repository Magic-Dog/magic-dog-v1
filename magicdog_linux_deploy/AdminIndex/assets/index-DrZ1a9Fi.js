import{L as le,e6 as ce,Q as c,S as M,V as N,R as f,d as W,W as Y,X as Z,bf as de,a2 as _,aS as me,aT as ue,co as ge,a as L,a0 as P,c_ as xe,a1 as fe,a6 as K,a5 as A,r as g,i as pe,as as ve,o as b,b as w,e as t,f as k,w as y,cu as E,t as x,h as C,H as ye,J as he,I as be,af as G,ae as $,B as J,g as Q,T as X,C as _e,e7 as we,e8 as ze,e9 as ke,ea as Ce,c as $e,cy as Se}from"./index-BQSxQzVO.js";import{u as Te}from"./use-houdini-CWXETERD.js";function Be(s){const{textColor3:o,infoColor:l,errorColor:d,successColor:r,warningColor:m,textColor1:p,textColor2:v,railColor:S,fontWeightStrong:T,fontSize:V}=s;return Object.assign(Object.assign({},ce),{contentFontSize:V,titleFontWeight:T,circleBorder:`2px solid ${o}`,circleBorderInfo:`2px solid ${l}`,circleBorderError:`2px solid ${d}`,circleBorderSuccess:`2px solid ${r}`,circleBorderWarning:`2px solid ${m}`,iconColor:o,iconColorInfo:l,iconColorError:d,iconColorSuccess:r,iconColorWarning:m,titleTextColor:p,contentTextColor:v,metaTextColor:o,lineColor:S})}const Ve={name:"Timeline",common:le,self:Be},q=1.25,Me=c("timeline",`
 position: relative;
 width: 100%;
 display: flex;
