import{V as p,Q as e,aA as F,S as C,R as j,aB as G,aC as H,d as E,W,X as L,aD as K,a as D,a0 as k,a1 as N,aE as Q,aF as X,a2 as n,aG as q}from"./index-UyGIsgrM.js";import{g as J}from"./get-slot-Bk_rJcZu.js";function M(t,b="default",a=[]){const{children:i}=t;if(i!==null&&typeof i=="object"&&!Array.isArray(i)){const l=i[b];if(typeof l=="function")return l()}return a}const U=p([e("descriptions",{fontSize:"var(--n-font-size)"},[e("descriptions-separator",`
