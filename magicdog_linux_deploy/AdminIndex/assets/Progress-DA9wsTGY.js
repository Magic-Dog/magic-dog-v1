import{d as z,a2 as r,a8 as W,ac as j,a9 as q,aa as O,ab as _,a as x,c_ as w,V as P,Q as s,S as C,X as G,W as T,dm as A,a0 as N,a1 as L}from"./index-iA9TGKTo.js";const M={success:r(j,null),error:r(q,null),warning:r(O,null),info:r(_,null)},X=z({name:"ProgressCircle",props:{clsPrefix:{type:String,required:!0},status:{type:String,required:!0},strokeWidth:{type:Number,required:!0},fillColor:[String,Object],railColor:String,railStyle:[String,Object],percentage:{type:Number,default:0},offsetDegree:{type:Number,default:0},showIndicator:{type:Boolean,required:!0},indicatorTextColor:String,unit:String,viewBoxWidth:{type:Number,required:!0},gapDegree:{type:Number,required:!0},gapOffsetDegree:{type:Number,default:0}},setup(e,{slots:p}){function u(n,o,i,l){const{gapDegree:c,viewBoxWidth:f,strokeWidth:y}=e,d=50,g=0,h=d,t=0,a=2*d,$=50+y/2,S=`M ${$},${$} m ${g},${h}
      a ${d},${d} 0 1 1 ${t},${-a}
